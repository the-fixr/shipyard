          ...
          <div className="space-y-4">
            ...
            <button
              ...
              className={`w-full p-4 rounded-xl border transition-all group ${
                isAuthenticating
                  ? 'bg-gray-800/50 border-gray-600/30 cursor-wait'
                  : 'bg-gradient-to-r from-green-600/30 to-emerald-600/30 hover:from-green-600/40 hover:to-emerald-600/40 border-green-500/30 hover:border-green-500/50'
              }`}
            >
              <div className="flex items-center gap-3">
                ...
                <div className="flex-1 text-left">
                  <div className="text-sm font-medium text-white">
                    {isAuthenticating ? 'Creating your repo...' : 'Create in My GitHub'}
                  </div>
